...
get_ipython().system('python train.py --data_dir flowers --save_dir checkpoints --arch vgg --learning_rate 0.003 --hidden_units 512 --epochs 1 --gpu')
...
get_ipython().system('python predict.py flowers/test/13/image_05745.jpg model_checkpoint.pth --top_k 5 --category_names cat_to_name.json --gpu')
